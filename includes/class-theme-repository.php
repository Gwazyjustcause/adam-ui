	...
	private function compatibility_aliases() {
		return implode(
			...
			array(
				...
				'--adam-night-button-bg:var(--adam-btn-secondary-bg);--adam-night-button-text:var(--adam-btn-secondary-text);--adam-night-button-border:var(--adam-btn-secondary-border);--adam-night-button-hover-bg:var(--adam-btn-secondary-hover-bg);--adam-night-button-hover-text:var(--adam-btn-secondary-hover-text);--adam-night-button-hover-border:var(--adam-btn-secondary-hover-border);--adam-night-accent:var(--adam-global-button-text);--adam-night-on-accent:var(--adam-btn-primary-text);',

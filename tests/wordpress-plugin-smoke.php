...
adam_ui_smoke_assert( '2.0.1' === adam_ui_smoke_header( $source, 'Version' ), 'Version header is invalid.' );
...
adam_ui_smoke_assert( defined( 'ADAM_UI_VERSION' ) && '2.0.1' === ADAM_UI_VERSION, 'ADAM_UI_VERSION is invalid.' );

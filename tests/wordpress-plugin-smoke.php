...
adam_ui_smoke_assert( '5.1.4' === adam_ui_smoke_header( $source, 'Version' ), 'Version header is invalid.' );
...
adam_ui_smoke_assert( defined( 'ADAM_UI_VERSION' ) && '5.1.4' === ADAM_UI_VERSION, 'ADAM_UI_VERSION is invalid.' );

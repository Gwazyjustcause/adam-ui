...
adam_ui_smoke_assert( '3.0.0' === adam_ui_smoke_header( $source, 'Version' ), 'Version header is invalid.' );
...
adam_ui_smoke_assert( defined( 'ADAM_UI_VERSION' ) && '3.0.0' === ADAM_UI_VERSION, 'ADAM_UI_VERSION is invalid.' );

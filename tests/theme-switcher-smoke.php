...
adam_ui_switcher_assert( false !== strpos( $base_css, '):not(.adam-theme-switcher__choice):not(.ct-toggle-dropdown-mobile):not(.ct-toggle-dropdown-desktop-ghost):not([role="combobox"]):not(.mce-btn):not(.ed_button):not(.tox-tbtn):not(.wp-switch-editor):focus-visible' ), 'Global button focus must defer to owned Theme Switcher, editor, dropdown, and Blocksy navigation controls.' );

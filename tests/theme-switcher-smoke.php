...
adam_ui_switcher_assert( false !== strpos( $base_css, '):not(.adam-theme-switcher__choice):not(.ct-toggle-dropdown-mobile):focus-visible' ), 'Global button focus must defer to owned Theme Switcher and navigation controls.' );
